...
public class PaymentHistoryService {
    ...
    public PaymentResponse create(Long userId, PaymentCreateRequest req) {
        Reservations r = reservationRepository.findById(req.getReservationId())
    ...
    public PaymentResponse confirm(Long userId, Long paymentId, PaymentConfirmRequest req) {
        ...
        if (!ph.getReservationId().equals(req.getReservationId())) {
        ...
        boolean ticketExists = ticketRepository.existsTicketByReservationId(req.getReservationId());
        if (ticketExists) {
