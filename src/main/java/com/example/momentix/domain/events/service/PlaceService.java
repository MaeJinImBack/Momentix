...
public class PlaceService {
    ...
    @Transactional
    public Places createPlace(PlacesRequestDto placesRequest) {
        Places place = placesRepository.findByPlaceName(
                placesRequest.getPlaceName()).orElseGet(() -> Places.builder()
